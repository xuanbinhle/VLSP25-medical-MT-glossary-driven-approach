...
if __name__ == '__main__':
    ...
    train_ind_envi = load_dataset("json", data_files="./Fixed/improved_prompts_ind_train_en2vi.jsonl", split="train")
    train_ind_vien = load_dataset("json", data_files="./Fixed/improved_prompts_ind_train_vi2en.jsonl", split="train")
    test_ind_envi = load_dataset("json", data_files="./Fixed/improved_prompts_ind_test_en2vi.jsonl", split="train")
    test_ind_vien = load_dataset("json", data_files="./Fixed/improved_prompts_ind_test_vi2en.jsonl", split="train")
    ...
    trainer = SFTTrainer(
        ...
        args = TrainingArguments(
            ...
            save_steps=500,
            seed = 3407,
            output_dir="qwen3_1.7B_new_unsloth",
            save_strategy="epoch",
            save_total_limit=2,
