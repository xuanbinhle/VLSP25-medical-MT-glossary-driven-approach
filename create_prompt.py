...
def process_dataset(src_path: str, tgt_path: str, output_path: str, lang: str,
    ...
    with open(src_path, "r", encoding="utf-8") as f_src, open(tgt_path, "r", encoding="utf-8") as f_tgt:
        for i, (src_line, tgt_line) in tqdm(enumerate(zip(f_src, f_tgt)), desc='Creating Message'):
...
# ========== Main ==========
def main(en_ind_traindata, vi_ind_traindata, en_ind_testdata, vi_ind_testdata, en_ood_data, vi_ood_data):
